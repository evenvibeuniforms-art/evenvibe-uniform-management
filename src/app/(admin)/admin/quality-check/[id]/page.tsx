...
import AdminQualityCheckDetailsView from "../views/AdminQualityCheckDetailsView";

export const metadata = {
  title: "Quality Check Workspace | EvenVibe Admin",
};

export default async function AdminQualityCheckDetailsPage({
  params,
}: {
  ...
  // Only allow orders that have reached production or beyond
  const validQCLifecycles = [
    "production",
    "quality_check",
    "packed",
    "dispatched",
  ...
  if (!validQCLifecycles.includes(order.status)) {
    notFound();
  }
  ...
  return (
    <AdminQualityCheckDetailsView
      order={formattedOrder}
      requirementItems={requirementItems || []}
      qcRecord={qcRecord || null}
      qcHistory={formattedQCHistory}
      productionSummary={productionRecord || null}
